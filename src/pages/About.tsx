...
import logo2 from "../pages/logo2.jpg"; // Assuming logo2.jpg is in the same directory as this file

const About = () => {
  const teamMembers = [
    {
      name: "Kiruthika",
      role: "CEO & Chief Operating Officer (COO) ",
      
      description: "Leads the company's strategic vision and operations"
    },
    {
      name: "Motheeshwaran",
      role: " Co-Founder & Chief Marketing Officer (CMO) &  HR",
     
      description: "Oversees brand, marketing strategy, and team culture"
    },
    {
      name: "Karthi",
      role: "CTO",
      
      description: "Leads technical vision and oversees product development"
    },
    
    {
      ...
      description: "Designs seamless user experiences and intuitive interfaces."
    },
    {
      name: "Rathish",
      role: "Chief Financial Officer (CFO)",
     
      description: "Responsible for financial planning, risk management, and budgeting."
    },
    {
      name: "Vishal",
      role: " Creative Director – Media & Content",
      
      description: "Drives storytelling, visual branding, and digital content strategy."
    },
    
    {
      ...
      description: "Heads the web development team and ensures technical execution."
    },
    {
      name: "Arthi",
      role: "Chief Financial Officer (CFO)",
     
      description: "Dual CFOs – may indicate joint responsibilities or distinct financial domains."
    }
  ];
